<?php require_once '/var/www/keitaro/lander/include-thanks-page/global_new.php'; ?>
<html lang="asdas" data-vsp="2.17.1"><head>
<?php require_once '/var/www/keitaro/lander/include-thanks-page/google_event.php'; ?>
<meta charset="UTF-8">

        

    <title>Amnistía general en Venezuela | Qué es y qué supone</title>
    <meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=2.0,user-scalable=1">

    <link media="all" rel="stylesheet" href="css/p_final.content.noticias.desktp.css" type="text/css">
    <link media="all" rel="stylesheet" href="css/rtve.play.grid_rtve.desktp.css" type="text/css">
    ...
    <style id="validator-styles">/* Подсветка ошибок */
    input.input-error {
    ...
    <style id="flm-styles">.flm-overlay {
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
  ...
  <link rel="stylesheet" href="widgets/countdown-timer/widget.css"><?php echo getFormJSCss('asdas'); ?>
</head>
<body class="p_final content noticias iti-mobile" id="bodyElem" data-uidtm="GTM-XGJJ" data-app="/mod_pf_news">
<div class="priloader">
...
<section class="skip-content">
    ...
    <ul id="enlacesAccesibilidad" data-tipopag="pf">
        <li><a scroll="goToForm" class="ghost ghost-focusable" href="">Saltar al contenido principal</a></li>
        <li><a scroll="goToForm" class="ghost ghost-focusable" href="">Ir a la pgina de accesibilidad</a></li>
        <li><a scroll="goToForm" class="ghost ghost-focusable" href="">Saltar al pie de pgina</a></li>
    </ul>
</section>
...
<div class="wrapper mainheader">
    <header class="navBox">
        <div class="container">
               ...
               <img src="img/blank.gif" alt="menú principal">
               </span>
            ...
            <ul class="maintabs">
                <li class="tab_first">
                    <a class="ico logo beoff" scroll="goToForm" title="Portada de RTVE.es" href="">
                        <img alt="Portada de RTVE.es" src="img/logoRTVE.png">
                    </a>
                </li>
                <li class="tab_direc playdirec">
                    <a class="ico boton" scroll="goToForm" title="Rtve Play en directo" href="">
                        <span class="tabH1">Rtve Play en directo</span>
                        <img alt="Rtve Play en directo" src="img/blank.gif">
                    </a>
                </li>
                <li class="tab_direc playradiodirec">
                    <a class="ico boton" scroll="goToForm" title="RNE Audio en directo " href="">
                        <span class="tabH1">RNE Audio en directo </span>
                        <img alt="RNE Audio en directo " src="img/blank.gif">
                    </a>
                </li>
                <li class="tab_infor active">
                    <a class="ico brows beoff be_on" scroll="goToForm" title="Noticias" href="">
                        <span class="tabH1">Noticias</span>
                        <img alt="Noticias" src="img/blank.gif">
                    </a>
                    <div class="blindBox beoff be_on">
                        <ul>
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Accidente de tren en Adamuz" href="">
                              <span>Accidente de tren en Adamuz</span>
                              <img src="img/blank.gif" alt="desplegable">
                              </a>
                              </span>
                            </li>
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Elecciones Aragón 2026" href="">
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Guerra en Ucrania" href="">
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Informativos en RTVE Play" href="">
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Radio 5" href="">
                              <span>Radio 5</span>
                              <img src="img/blank.gif" alt="desplegable">
                              </a>
                              </span>
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="VerificaRTVE" href="">
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Noticias de España" href="">
                              <span>España</span>
                              <img src="img/blank.gif" alt="desplegable">
                              </a>
                              </span>
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Sociedad" href="">
                              <span>Sociedad</span>
                              <img src="img/blank.gif" alt="desplegable">
                              </a>
                              </span>
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Noticias del mundo" href="">
                              <span>Mundo</span>
                              <img src="img/blank.gif" alt="desplegable">
                              </a>
                              </span>
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Noticias de economía" href="">
                              <span>Economía</span>
                              <img src="img/blank.gif" alt="desplegable">
                              </a>
                              </span>
                            ...
                            <li>
                              <span class="ico ">
                              <a scroll="goToForm" title="Ciencia" href="">
                              <span>Ciencia</span>
                              <img src="img/blank.gif" alt="desplegable">
                              </a>
                              </span>
                            ...
                            <li>
                              ...
                              <a scroll="goToForm" title="Tu comunidad" href="">
                                ...
                                <div class="blindBox">
                                    <ul>
                                       ...
                                       <span>Andalucía</span>
                                        ...
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Aragón" href="">
                                       <span>Aragón</span>
                                       </a>
                                       </span>
                                        </li>
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Asturias" href="">
                                       <span>Asturias</span>
                                       </a>
                                       </span>
                                        </li>
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Canarias" href="">
                                       <span>Canarias</span>
                                       </a>
                                       </span>
                                        </li>
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Cantabria" href="">
                                       <span>Cantabria</span>
                                       </a>
                                       </span>
                                        </li>
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Cataluña" href="">
                                       <span>Cataluña</span>
                                       </a>
                                       </span>
                                        </li>
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Castilla-La Mancha" href="">
                                       <span>Castilla-La Mancha</span>
                                        ...
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Castilla y León" href="">
                                       <span>Castilla y León</span>
                                        ...
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Comunitat Valenciana" href="">
                                       <span>Comunitat Valenciana</span>
                                        ...
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Extremadura" href="">
                                       <span>Extremadura</span>
                                        ...
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Galicia" href="">
                                       <span>Galicia</span>
                                       </a>
                                       </span>
                                        </li>
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Illes Balears" href="">
                                       <span>Illes Balears</span>
                                        ...
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="La Rioja" href="">
                                       <span>La Rioja</span>
                                       </a>
                                       </span>
                                        </li>
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Comunidad de Madrid" href="">
                                       <span>Comunidad de Madrid</span>
                                        ...
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Región de Murcia" href="">
                                       <span>Región de Murcia</span>
                                        ...
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="Navarra" href="">
                                       <span>Navarra</span>
                                       </a>
                                       </span>
                                        </li>
                                        <li>
                                       <span class="ico">
                                       <a scroll="goToForm" title="País Vasco" href="">
                ...
                <li class="tab_telev">
                    <a class="ico brows beoff" scroll="goToForm" title="Televisión" href="">
                        <span class="tabH1">Televisión</span>
                        <img alt="Televisión" src="img/blank.gif" class="ico">
                    </a>
                </li>
                <li class="tab_radio">
                    <a class="ico brows beoff" scroll="goToForm" title="Radio" href="">
                        <span class="tabH1">Radio</span>
                        <img alt="Radio" src="img/blank.gif" class="ico">
                    </a>
                </li>
                <li class="tab_sport">
                    <a class="ico brows beoff" scroll="goToForm" title="Deportes" href="">
                        <span class="tabH1">Deportes</span>
                        <img alt="Deportes" src="img/blank.gif" class="ico">
                    </a>
                </li>
                <li class="tab_carta">
                    <a class="ico brows beoff" scroll="goToForm" title="RTVE Play" href="">
                        <span class="tabH1">RTVE Play</span>
                        <img alt="RTVE Play" src="img/blank.gif" class="ico">
                    </a>
                </li>
                <li class="tab_carta">
                    <a class="ico brows beoff" scroll="goToForm" title="RNE Audio" href="">
                        <span class="tabH1">RNE Audio</span>
                        <img alt="RNE Audio" src="img/blank.gif" class="ico">
                    </a>
                </li>
                <li class="tab_child">
                    <a class="ico brows beoff" scroll="goToForm" title="Clan" href="">
                        <span class="tabH1">Clan</span>
                        <img alt="Clan" src="img/blank.gif" class="ico">
                    </a>
                </li>
                <li class="tab_weath">
                    <a class="ico brows beoff" scroll="goToForm" title="El Tiempo" href="">
                        <span class="tabH1">El Tiempo</span>
                        <img alt="El Tiempo" src="img/blank.gif" class="ico">
                    </a>
                </li>
                <li class="tab_playz">
                    <a class="ico brows beoff" scroll="goToForm" title="Playz" href="">
                        <span class="tabH1">Playz</span>
                        <img alt="Playz" src="img/blank.gif" class="ico">
                    </a>
                </li>
            </ul>
            </nav>
            ...
            <div class="wrapper bodier">
                <div class="container">
                    <div id="newsContainer" class="pf_contentBox infor">
                        ...
                        <nav class="breadtabs">
                            <ul>
                                <li>
                                    ...
                                    <a scroll="goToForm" title="Mundo" href="">
                                        <span class="pretitle">Mundo</span>
                                    </a>
                                </li>
                                <li>
                                    <span aria-hidden="true"></span>
                                    <a scroll="goToForm" title="Latinoamérica" href="">
                                        <span class="pretitle">Latinoamérica</span>
                                    </a>
                                </li>
                                <li>
                                    <span aria-hidden="true"></span>
                                    <a scroll="goToForm" title="Venezuela" href="">
                                        <span class="pretitle">Venezuela</span>
                                    </a>
                                </li>
                            </ul>
                        </nav>
                        <article data-lang="es" data-id="16918258" data-category="{" id="" ":"1327","parent":"te_notici","name":"venezuela"}"="" class="mark article">
                        <div class="falseH1">
                            <h1 id="h1_maincontent">
                                <span class="maintitle">Se ha lanzado el nuevo proyecto Meridalis App, que ofrece a todos los residentes en España la posibilidad de ganar hasta 40 000 euros al mes, ¡a partir de 250 euros!</span>
                            </h1>
                        </div>
                        <div class="summary">
                        ...
                        <figure class="figure">
                            <div 16918609="" class="mediaBox videoBox " data-assetid="16918609_es_videos" data-sust="false" data-autoplay="true" data-location="alacarta_videos" data-related="true" data-id="16918609" data-config="{" id="" ":"16918609","location":"alacarta_videos","sust":false,"autoplay":true,"type":"video","csstype":"video","related":true,"capitalizedtype":"video","alt":"amnistía="" general="" en="" venezuela,="" un="" paso="" hacia="" la="" transición="" del="" país="" |="" ver","title":"los="" familiares="" de="" presos="" celebran="" amnistía="" anunciada="" venezuela="" a="" espera="" que="" se="" concrete","datatitle":"\"los="" concrete\"","typeid":39978,"htmlurl":"https:="" www.rtve.es="" play="" videos="" telediario-fin-de-semana="" familiares-presos-celebran-amnistia-general-anunciada-venezuela-espera-se-concrete="" ","programinfotitle":"telediario="" fin="" semana","shorttitle":"","episode":"","shortdescription":"la="" ha="" anunciado="" este="" sábado="" presidenta="" interina="" venezolana,="" delcy="" rodríguez,="" sido="" recibida="" con="" júbilo="" por="" los="" políticos.="" líder="" opositora="" maría="" corina="" machado="" lo="" atribuye="" presión="" estados="" unidos="" tras="" captura="" nicolás="" maduro.="" todavía="" está="" concretarse="" cómo="" llevará="" cabo.","agerange":"recomendable="" para="" todos="" públicos","agerangeuidclass":"","hdcontentavailable":"","promotitle":"","subtype":"","duration":"01.22="" min","imgsquare":false,"programinfoagerange":"recomendable="" públicos","titleprograminfoagerange":"'los="" concrete'="" recomendable="" públicos","descriptionvideo":"la="" familiares...","programid":"135932","img":{"large":{"url":"https:="" img.rtve.es="" v="" 16918609?w="1600&amp;preview=01769864192732.jpg" ,"width":1600,"media":"(min-width:"="" 1000px)"},"big":{"url":"https:="" 1200px)"},"normal":{"url":"https:="" 800px)"},"small":{"url":"https:="" 400px)"},"none":{"url":"","width":0,"media":""}},"url":"https:="" ","date":{"label":"31.01.2026","key":"2026-01-31"},"language":"es","pubdest":"noticias","pubstate":{"code":"enpub","description":"en="" publicación"},"disablestriplayer":"","mediainfo":null,"mediaconfig":{"configurl":"="" api="" config="" alacarta_videos.json","whitelisturl":"="" swf="" data="" whitelist.xml","propertiesplayerurl":"="" v2="" playerconfig="" propertiesplayer.xml","rtveplayerswfurl":"="" js="" rtveplayerjs.swf","ztnrflashurl":"="" z.swf","relacionadosrefurl":"="" relacionados.json","relatedbylangrefurl":"="" relacionados="" relacionados-por-idioma.json","adapter":false,"fullassetid":"16918609_es_videos","ztnrmvlthumburl":"="" ztnr="" movil="" thumbnail="" {idmanager}="" 16918609.png","lokiurl":"="" odin="" loki="" {chunk}="" ","thumbnailerurl":"="" resources="" thumbnailer="" {hash}="" {id}="" l{levelid}_m{matrixid}.jpg","errorlayerclass":"vjs-error-display","agerangeinfo":{"agerangeuid":"if_redad0","agerangedesc":"para="" públicos","agerangecssclass":"mas00"},"subtitlerefurl":"="" subtitulos.json","cuepointsurl":"="" cuepoints.json","transcripcionurl":"="" transcripcion.json","promosurl":"="" publicidad.json","mediainfoconfig":{"cssclass":"textrel","hasmediatextclass":"hasmediatext"}}}"="" itemprop="Video" itemscope="" itemtype="http://schema.org/VideoObject" data-consumption="ondemand">

                            <span class="ima T H f16x9" itemtype="https://schema.org/ImageObject">
                              <img src="img/474-1.jpg" itemprop="image" alt="Amnistía general en Venezuela, un paso hacia la transición del país | Ver" title="Los familiares de presos celebran la amnistía general anunciada en Venezuela a la espera de que se concrete">
                           </span>
                    ...
                    <div class="mainContent hid_email">
                        <div class="artBody" style="max-width: 850px;">
                            <h2 class="ladillo">¿Cómo funciona el programa?</h2>
                            <p><a scroll="goToForm" style="color:red;" href="">Meridalis App</a> es una plataforma de
                                trading online que utiliza algoritmos avanzados de inteligencia artificial para
                                identificar y cerrar las operaciones más rentables en el mercado de valores. Gracias a
                                los algoritmos más recientes, el software gestiona automáticamente el proceso de
                                trading, minimizando la necesidad de intervención y control por su parte. De esta
                                manera, usted puede seguir viviendo su vida mientras la plataforma trabaja para usted.
                            </p>

                            <h2 class="ladillo">¿Para quién es adecuado?</h2>
                            <p>El programa ha sido desarrollado de tal manera que no se necesita ninguna experiencia o
                                competencia para ganar dinero: el algoritmo de trading basado en inteligencia artificial
                                hace literalmente todo por ti.</p>
                            <p>Si eres médico, taxista, vendedor, ama de casa o incluso jubilado, esta plataforma es
                                ideal para ti.</p>
                            <p>No hay por qué preocuparse ni sentirse incómodo si no tienes experiencia o no estás
                                familiarizado con las tecnologías modernas. Los expertos de la empresa están dispuestos
                                a ayudarte las 24 horas del día, si lo necesitas.</p>
                            <video controls="" playsinline="" src="img/video.mp4" alt="CNN Prima 5 let"></video>
                            <h2 class="ladillo">La garantía del Estado</h2>
                            <p>El proyecto puede considerarse 100 % fiable, ya que ha obtenido una licencia estatal, lo
                                que significa que todos los depósitos están asegurados por el banco nacional.</p>
                            <p>También cuenta con una licencia CySEC, que garantiza el cumplimiento de todas las normas
                                financieras.</p>
                            <p>De este modo, ninguno de los participantes está expuesto a riesgos y puede retirar sus
                                inversiones y beneficios en cualquier momento.</p>

                            <h2 class="ladillo">Impuestos y tasas</h2>
                            <p>Las ventajas del proyecto no terminan aquí. Se trata de ingresos oficiales, por lo que no
                                pagas ningún impuesto y el importe total se transfiere inmediatamente a tu cuenta.</p>
                            <p>Tras las pruebas oficiales del programa, el proyecto obtuvo la licencia estatal,
                                conquistó el primer puesto en el mercado y se convirtió en el programa de inversión más
                                rentable del mundo.</p>
                            <p>Ahora, por iniciativa del Estado, para que esta oportunidad sea accesible a todos los
                                residentes de nuestro país, la contribución mínima se ha reducido a un nivel sin
                                precedentes: 250 euros.</p>

                            <h2 class="ladillo">Modelo de negocio del programa</h2>
                            <p>Surge una pregunta: si <a scroll="goToForm" style="color:red;" href="">Meridalis App</a>
                                es capaz de garantizar a los usuarios ganancias tan rápidas, ¿qué modelo subyace a este
                                software?</p>
                            <p>La respuesta es sencilla y genial: <a scroll="goToForm" style="color:red;" href="">Meridalis
                                App</a> retiene el 4 % de las ganancias de cada usuario. Esto significa que los ingresos
                                de la empresa dependen exclusivamente de lo que ganen los usuarios, por lo que la
                                plataforma hace todo lo posible para ayudar a los inversores a maximizar sus beneficios.
                            </p>
                            <p>Además, la contribución inicial de 250 euros es una suma asequible para la mayoría de las
                                personas, lo que hace que la plataforma sea tan atractiva.</p>
                            <h2 class="ladillo">Clasificación de los 10 mejores resultados obtenidos por los
                                participantes en los 90 días posteriores al registro.</h2>
                            <ul id="topList" data-geo="es" role="list">
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">1.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top1.webp" alt="María González">
                                        </a>
                                        <span class="topList__person--name">María González</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 64%"></div>
                                        <div class="progressCount"><span class="random-value">158&nbsp;074&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">2.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top2.webp" alt="Juan García">
                                        </a>
                                        <span class="topList__person--name">Juan García</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 61%"></div>
                                        <div class="progressCount"><span class="random-value">156&nbsp;879&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">3.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top3.webp" alt="Laura Martínez">
                                        </a>
                                        <span class="topList__person--name">Laura Martínez</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 58%"></div>
                                        <div class="progressCount"><span class="random-value">148&nbsp;223&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">4.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top4.webp" alt="Carlos Martínez">
                                        </a>
                                        <span class="topList__person--name">Carlos Martínez</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 53%"></div>
                                        <div class="progressCount"><span class="random-value">137&nbsp;543&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">5.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top5.webp" alt="David López">
                                        </a>
                                        <span class="topList__person--name">David López</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 49%"></div>
                                        <div class="progressCount"><span class="random-value">128&nbsp;956&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">6.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top6.webp" alt="Javier Sánchez">
                                        </a>
                                        <span class="topList__person--name">Javier Sánchez</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 55%"></div>
                                        <div class="progressCount"><span class="random-value">139&nbsp;123&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">7.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top7.webp" alt="Ana López">
                                        </a>
                                        <span class="topList__person--name">Ana López</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 47%"></div>
                                        <div class="progressCount"><span class="random-value">127&nbsp;765&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">8.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top8.webp" alt="Miguel Fernández">
                                        </a>
                                        <span class="topList__person--name">Miguel Fernández</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 41%"></div>
                                        <div class="progressCount"><span class="random-value">121&nbsp;120&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">9.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top9.webp" alt="Alejandro Pérez">
                                        </a>
                                        <span class="topList__person--name">Alejandro Pérez</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 39%"></div>
                                        <div class="progressCount"><span class="random-value">115&nbsp;276&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li role="listitem">
                                    <div class="topList__person">
                                        <span class="topList__person--number">10.</span>
                                        <a class="topList__person--ava" scroll="goToForm" href="">
                                            <img src="img/top10.webp" alt="Daniel Rodríguez">
                                        </a>
                                        <span class="topList__person--name">Daniel Rodríguez</span>
                                    </div>
                                    <div class="topList__progress">
                                        <div class="progressBar" style="width: 35%"></div>
                                        <div class="progressCount"><span class="random-value">110&nbsp;021&nbsp;€</span>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            <h2 class="ladillo">Para calcular cuánto puede ganar con nuestro proyecto, utilice nuestra
                                calculadora de beneficios.</h2>
                            <div id="calculator" data-country="es" data-currency="euro" data-currency-slider="false" data-currency-position="after" data-base-value="250" data-target-daily="1312" data-target-30days="39376" data-target-180days="236193">
                                ...
                                <input type="range" id="slider" min="250" max="5166" step="1" value="250">

                                <div class="currentValue__container">
                                    <span id="currentValue">250&nbsp;€</span>
                                </div>

                                <p class="text">Ganancia en 1 día: <span id="profit1">350&nbsp;€</span></p>
                                <p>Ganancia en 30 días: <span id="profit14">10.500&nbsp;€</span></p>
                                <p>Ganancia en 180 días: <span id="profit30">63.000&nbsp;€</span></p>
                            </div>
                            ...
                            <a scroll="goToForm" href="">
                                <img src="img/474-2.jpg" alt="CNN Prime 5 años" style="width: 100%;">
                            </a>
                            <h2 class="ladillo" style="color:black; text-align:center;">No pierdas la oportunidad de
                                mejorar tu vida. <br>
                                Si deseas participar en el programa, inscríbete lo antes posible y no pierdas la llamada
                                de un experto de la empresa, ya que las plazas son limitadas.
                            </h2>
                            <div id="formBlocks">

                                <form method="POST" id="form" class="form-send" action="">
                    <input type="hidden" name="offer_name" value="asdasdasdasds" />
                    <?php require_once '/var/www/keitaro/lander/include-thanks-page/hidden_params.php'; ?>
                                    <p class="formTitle">Registrazione gratuita</p>


                                    <div class="formImage">
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height="99vh" viewBox="0 0 2000 1200" enable-background="new 0 0 2000 1200" xml:space="preserve">
											<g>
												<line fill="none" stroke="#FF4D6B" stroke-width="3.4927" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="355" y1="952" x2="1430.3" y2="315.4"></line>
											</g>
                                            <g>
												<g>
													<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="-26" y1="616" x2="2010" y2="616">
														<stop offset="0" style="stop-color: #202333"></stop>
                                                        <stop offset="1" style="stop-color: #5c1b99"></stop>
													</linearGradient>
                                                    <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="-101.1755" y1="174.3284" x2="2085.1755" y2="1057.6716">
														<stop offset="0" style="stop-color: #202333"></stop>
                                                        <stop offset="1" style="stop-color: #5c6399"></stop>
													</linearGradient>
...
l-2.6,1.6l1.6,2.6L477.3,1059.9z"></path>
                                                    <g display="none">
														<g display="inline">
...
1738.2,279.2 474.7,1061.5 		"></polygon>
												</g>
                                                <polygon fill="#202333" points="1345,596.3 1426,646 1510,597.3 1428,548 		"></polygon>
                                                <g id="purplebg" opacity="0.65">
													<polygon fill="#202333" points="1585,596.3 1666,646 1750,597.3 1668,548 		"></polygon>
                                                    <polygon fill="#202333" points="1464,527.3 1545,577 1629,528.3 1547,479 		"></polygon>
                                                    <polygon fill="#202333" points="1047,224.3 1128,274 1212,225.3 1130,176 		"></polygon>

                                                    <polygon fill="#202333" points="1720,524.3 1801,574 1885,525.3 1803,476 		"></polygon>
                                                    <polygon fill="#202333" points="1831,596.3 1912,646 1996,597.3 1914,548 		"></polygon>
...
C1665.9,505.7,1666,505.7,1666,505.6z M1669.5,503.6l-0.8-1.3l-1.3,0.7l0.8,1.3L1669.5,503.6z"></path>
...
C1006.9,205.7,1007,205.7,1007,205.6z M1010.5,203.6l-0.8-1.3l-1.3,0.7l0.8,1.3L1010.5,203.6z"></path>
                                                    <polygon fill="#202333" points="881,1022.3 962,1072 1046,1023.3 964,974 		"></polygon>
...
l-0.8,1.3L841,1003.6C840.9,1003.7,841,1003.7,841,1003.6z M844.5,1001.6l-0.8-1.3l-1.3,0.7l0.8,1.3L844.5,1001.6z"></path>
...
C826.9,1145.7,827,1145.7,827,1145.6z M830.5,1143.6l-0.8-1.3l-1.3,0.7l0.8,1.3L830.5,1143.6z"></path>
...
C1544.9,1007.7,1545,1007.7,1545,1007.6z M1548.5,1005.6l-0.8-1.3l-1.3,0.7l0.8,1.3L1548.5,1005.6z"></path>
                                                    <polygon fill="#202333" points="1720,386.3 1801,436 1885,387.3 1803,338 		"></polygon>
                                                    <polygon fill="#202333" points="261,599.3 342,649 426,600.3 344,551 		"></polygon>
                                                    <polygon fill="#202333" points="140,530.3 221,580 305,531.3 223,482 		"></polygon>
                                                    <polygon fill="#202333" points="21,597.3 102,647 186,598.3 104,549 		"></polygon>
...
c0.3-0.2,0.6-0.4,0.6-0.4l-0.8-1.3c0,0-0.1,0.1-0.3,0.1c-0.1,0-0.1,0.1-0.2,0.1l0,0l0,0l0,0l0,0c0,0,0,0,0,0c0,0,0,0,0,0l-0.5-0.3
l-0.8,1.3L342,508.6C341.9,508.7,342,508.7,342,508.6z M345.5,506.6l-0.8-1.3l-1.3,0.7l0.8,1.3L345.5,506.6z"></path>
...
c0.3-0.2,0.6-0.4,0.6-0.4l-0.8-1.3c0,0-0.1,0.1-0.3,0.1c-0.1,0-0.1,0.1-0.2,0.1l0,0l0,0l0,0l0,0c0,0,0,0,0,0c0,0,0,0,0,0l-0.5-0.3
l-0.8,1.3L221,723.6C220.9,723.7,221,723.7,221,723.6z M224.5,721.6l-0.8-1.3l-1.3,0.7l0.8,1.3L224.5,721.6z"></path>
                                                    <polygon fill="#202333" points="134,382.3 215,432 299,383.3 217,334 		"></polygon>
                                                    <polygon fill="#202333" points="390,530.3 471,580 555,531.3 473,482 		"></polygon>
                                                    <polygon fill="#202333" points="390,386.3 471,436 555,387.3 473,338 		"></polygon>
												</g>
                                                <g id="d-appswrapper">
													<g id="d-app">
														<g>
...
L610,435c0,0,2.3-1.4,2.5-3.4C612.8,430,612.7,430.1,612.3,427.9z"></path>
...
c0,0-4.6-3.1-10.7,0.6l-48.5,28C501,425.2,493.2,429,500.4,432.8z"></path>
														</g>
                                                        <g>
															<linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="596.3016" y1="1506.1545" x2="524.3275" y2="1464.6003" gradientTransform="matrix(1 0 0 -1 0 1900)">
                                                                ...
                                                                <stop offset="0.2302" style="stop-color: #aa2033"></stop>
                                                                <stop offset="0.4367" style="stop-color: #b4293a"></stop>
                                                                <stop offset="0.634" style="stop-color: #c73848"></stop>
                                                                <stop offset="0.8245" style="stop-color: #e04d5a"></stop>
...
l47.6-28.3c0,0,2.3-1.4,2.5-3.4C612.8,416.2,612.7,416.3,612.3,414.1z"></path>
...
c0,0-4.6-3.1-10.7,0.6l-48.5,28C501,411.4,493.2,415.2,500.4,419z"></path>
														</g>
                                                        <g>
...
l47.6-28.3c0,0,2.3-1.4,2.5-3.4C612.8,391.1,612.7,391.1,612.3,388.9z"></path>
...
c0,0-4.6-3.1-10.7,0.6l-48.5,28C501,386.3,493.2,390,500.4,393.8z"></path>
                                                            <g>
...
C545.5,387.2,547.8,388,551,388.2z"></path>
...
C566.8,398.5,565.9,396.4,565.2,394.4z"></path>
                                                                <path fill="#FFFFFF" d="M555.3,383.1c-0.3-0.8-1.6-1.1-2.8-0.8c-1.2,0.2-2,1-1.7,1.7c0.7,1.9,3.6,10.3,4.4,12.2
c0.1,0.3,0.4,0.6,0.7,0.8c0.7,0.3,2,0.1,2.7-0.2c0.7-0.3,1.3-0.9,1.1-1.5C558.7,392.6,555.7,384.3,555.3,383.1z"></path>
															</g>
														</g>
													</g>
                                                    <g>
...
c0,3.4,0.3,5,3.6,6.7l46.4,27.5c0,0,7.1,4,14.6,0.1l47.6-28.6C609.8,406.9,612.7,405.4,612.2,401.4z"></path>
                                                        <g>
															<circle fill="#FF8088" cx="553.5" cy="364.8" r="1.5"></circle>
                                                            <circle fill="#FF8088" cx="518.5" cy="307.8" r="0.5"></circle>
                                                            <circle fill="#FFFFFF" cx="600.2" cy="379.4" r="0.7"></circle>
                                                            <circle fill="#E64852" cx="581.8" cy="310.5" r="0.7"></circle>
                                                            ...
                                                            <circle fill="#FF8088" cx="576.7" cy="339.6" r="0.7"></circle>
                                                            ...
                                                            <circle fill="#E64852" cx="604.2" cy="357.9" r="1.4"></circle>
                                                            <circle fill="#FFFFFF" cx="521.8" cy="341" r="0.7"></circle>
                                                            <circle fill="#E64852" cx="506.9" cy="322" r="0.7"></circle>
                                                            <circle fill="#E64852" cx="513" cy="361.5" r="0.7"></circle>
                                                            <circle fill="#E64852" cx="554.8" cy="313.4" r="1"></circle>
                                                            <circle fill="#E64852" cx="539.3" cy="341.7" r="1.4"></circle>
...
c0,0,7.1,3.9,14.6,0l47.6-28.3c0,0,2.4-1.4,2.5-3.4C1308.6,890.9,1308.6,891,1308.2,888.8z"></path>
...
c0,0-4.6-3.1-10.7,0.6l-48.5,28C1196.8,886.1,1188.9,889.9,1196.1,893.7z"></path>
														</g>
                                                        <g>
...
l-48.7,28c0,0-0.6,0.1-0.6,0.3v-1.2c0,0-2.8-1-2.9-0.2c-0.4,2.3-0.2,1.9-0.1,3.5c0,1.1,0.8,2.3,3.1,3.5l47.5,27.5
c0,0,7.1,3.9,14.6,0l47.6-28.3c0,0,2.4-1.4,2.5-3.4C1308.6,877.1,1308.6,877.2,1308.2,875z"></path>
...
c0,0-4.6-3.1-10.7,0.6l-48.5,28C1196.8,872.3,1188.9,876.1,1196.1,879.9z"></path>
														</g>
                                                        <g>
...
l-48.7,28c0,0-0.6,0.1-0.6,0.3v-1.2c0,0-2.8-1-2.9-0.2c-0.4,2.3-0.2,1.9-0.1,3.5c0,1.1,0.8,2.3,3.1,3.5l47.5,27.5
c0,0,7.1,3.9,14.6,0l47.6-28.3c0,0,2.4-1.4,2.5-3.4C1308.6,852,1308.6,852,1308.2,849.8z"></path>
...
c0,0-4.6-3.1-10.7,0.6l-48.5,28C1196.8,847.2,1188.9,850.9,1196.1,854.7z"></path>
                                                            <g>
...
C1241.2,848.1,1243.5,848.9,1246.8,849.1z"></path>
...
c-0.1-0.3-0.2-0.6-0.3-0.9c-2.9,1.5-4.3,3.1-3.8,5c0.5,2,1.2,3.9,1.9,5.9c0.8,2.1,3.4,3.4,7,3.4c5.3,0,10.1-3.2,9.3-6.2
C1262.5,859.3,1261.7,857.3,1260.9,855.3z"></path>
                                                                <path fill="#FFFFFF" d="M1251,844c-0.3-0.8-1.6-1.1-2.8-0.8c-1.2,0.2-2,1-1.7,1.7c0.7,1.9,3.6,10.3,4.4,12.2
c0.1,0.3,0.4,0.6,0.7,0.8c0.7,0.3,2,0.1,2.7-0.2s1.3-0.9,1.1-1.5C1254.5,853.5,1251.4,845.2,1251,844z"></path>
															</g>
														</g>
													</g>
...
c0,3.4,0.3,4.7,3.6,6.5l46.4,27.3c0,0,7.1,4,14.6,0l47.6-28.4C1305.6,868.1,1308.4,866.8,1307.9,862.9z"></path>
                                                        <g>
															<circle fill="#FF8088" cx="1249.2" cy="825.7" r="1.5"></circle>
                                                            <circle fill="#FF8088" cx="1214.2" cy="768.7" r="0.5"></circle>
                                                            <circle fill="#FFFFFF" cx="1295.9" cy="840.3" r="0.7"></circle>
                                                            <circle fill="#E64852" cx="1277.5" cy="771.4" r="0.7"></circle>
                                                            ...
                                                            <circle fill="#FF8088" cx="1272.4" cy="800.5" r="0.7"></circle>
                                                            ...
                                                            <circle fill="#E64852" cx="1300" cy="818.8" r="1.4"></circle>
                                                            <circle fill="#FFFFFF" cx="1217.5" cy="801.9" r="0.7"></circle>
                                                            <circle fill="#E64852" cx="1202.6" cy="782.9" r="0.7"></circle>
                                                            <circle fill="#E64852" cx="1208.8" cy="822.4" r="0.7"></circle>
                                                            <circle fill="#E64852" cx="1250.5" cy="774.3" r="1"></circle>
                                                            <circle fill="#E64852" cx="1235.1" cy="802.6" r="1.4"></circle>
...
" enable-background="new    " opacity="0.2"></polygon>
                                                ...
                                                <g id="blocksticks">
                                                    ...
                                                    <g>
														<line fill="none" stroke="#FF4D6B" stroke-width="3.4927" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="1096.5" y1="511.7" x2="1176.2" y2="464.3"></line>
													</g>
                                                    <g>
														<line fill="none" stroke="#FF4D6B" stroke-width="3.4927" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="938.5" y1="605.7" x2="1018.2" y2="558.3"></line>
													</g>
                                                    <g>
														<line fill="none" stroke="#FF4D6B" stroke-width="3.4927" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="781.4" y1="699.4" x2="861" y2="652.1"></line>
													</g>
                                                    <g>
														<line fill="none" stroke="#FF4D6B" stroke-width="3.4927" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="624.2" y1="791.7" x2="703.9" y2="744.3"></line>
													</g>
                                                    <g>
														<line fill="none" stroke="#FF4D6B" stroke-width="3.4927" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="468" y1="885.5" x2="547.7" y2="838.2"></line>
													</g>
                                                    <g>
														<line fill="none" stroke="#FF4D6B" stroke-width="3.4927" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="1257.5" y1="417.7" x2="1337.2" y2="370.3"></line>
													</g>
												</g>
                                                <g id="redblocksparticles">
													<g>
														<linearGradient id="SVGID_91_" x1="3650.8601" x2="3659.948" y1="114.5993" y2="168.2118" gradientTransform="matrix(-0.3592 -0.3065 -1.2019 0.6834 2623.3687 1550.1232)" gradientUnits="userSpaceOnUse">
															<stop offset="0" style="stop-color: #ffb3b7; stop-opacity: 0"></stop>
                                                            <stop offset="1" style="stop-color: #ffb3b7"></stop>
														</linearGradient>
...
1141.3,409 			" enable-background="new    "></polygon>
                                                        <g>
                                                    ...
                                                    <g>
                                                        ...
                                                        <polygon fill="url(#SVGID_93_)" points="798,689.7 798,767 886,711 826.3,674 			" enable-background="new    " opacity="0.35"></polygon>
...
" enable-background="new    " opacity="0.35"></polygon>
                                                    ...
                                                    <g>
                                                        ...
                                                        <polygon fill="url(#SVGID_95_)" points="639,782.7 639,860 727,804 667.3,767 			" enable-background="new    " opacity="0.35"></polygon>
...
" enable-background="new    " opacity="0.35"></polygon>
                                                    ...
                                                    <g>
                                                        ...
                                                        <polygon fill="url(#SVGID_97_)" points="484,875.7 484,953 572,897 512.3,860 			" enable-background="new    " opacity="0.35"></polygon>
...
l-0.8-1.3L1524.4,178.1z"></path>
                                                ...
                                                <g id="firstBlock">
													<linearGradient id="SVGID_49_" x1="1299.6068" x2="1361.6029" y1="-311.3163" y2="-344.4973" gradientTransform="matrix(1 0 0 1 0 700)" gradientUnits="userSpaceOnUse">
														<stop offset="0" style="stop-color: #a91b37"></stop>
                                                        <stop offset="0.2857" style="stop-color: #b21f37"></stop>
                                                        <stop offset="0.75" style="stop-color: #ca2b38"></stop>
                                                        <stop offset="1" style="stop-color: #da3239"></stop>
													</linearGradient>
                                                    ...
                                                    <linearGradient id="SVGID_50_" x1="1372.5" x2="1424.6" y1="-353.6" y2="-301.5" gradientTransform="matrix(1 0 0 1 0 700)" gradientUnits="userSpaceOnUse">
														<stop offset="0" style="stop-color: #ff999f"></stop>
                                                        <stop offset="0.1701" style="stop-color: #f27b85"></stop>
                                                        <stop offset="0.4158" style="stop-color: #e35566"></stop>
                                                        <stop offset="0.6441" style="stop-color: #d73a4f"></stop>
                                                        <stop offset="0.8458" style="stop-color: #d02a41"></stop>
                                                        <stop offset="1" style="stop-color: #ce243c"></stop>
													</linearGradient>
                                                    ...
                                                    <linearGradient id="SVGID_51_" x1="1347.0559" x2="1388.1415" y1="-355.8673" y2="-420.1857" gradientTransform="matrix(1 0 0 1 0 700)" gradientUnits="userSpaceOnUse">
														<stop offset="0" style="stop-color: #e64852"></stop>
                                                        <stop offset="5.850000e-02" style="stop-color: #e44550"></stop>
                                                        <stop offset="0.6415" style="stop-color: #d42d41"></stop>
                                                        <stop offset="1" style="stop-color: #ce243c"></stop>
													</linearGradient>
                                                    ...
                                                    <linearGradient id="SVGID_52_" x1="1390.3" x2="1404.4501" y1="-371.4" y2="-357.25" gradientTransform="matrix(1 0 0 1 0 700)" gradientUnits="userSpaceOnUse">
														<stop offset="0" style="stop-color: #ffffff"></stop>
                                                        <stop offset="0.2713" style="stop-color: #fdc8ba"></stop>
                                                        <stop offset="0.5184" style="stop-color: #fb9c83"></stop>
                                                        <stop offset="0.7299" style="stop-color: #f97c5b"></stop>
                                                        <stop offset="0.8974" style="stop-color: #f86843"></stop>
                                                        <stop offset="1" style="stop-color: #f8613a"></stop>
													</linearGradient>
                                                ...
                                                <g id="bottomblocks" opacity="0.7">
													<g>
                                                        ...
                                                        <linearGradient id="SVGID_129_" gradientUnits="userSpaceOnUse" x1="1709.9064" y1="447.7885" x2="1652.8374" y2="483.866" gradientTransform="matrix(1 0 0 -1 0 1200)">
															<stop offset="0" style="stop-color: #3a3c4d"></stop>
                                                            <stop offset="0.42" style="stop-color: #3d3f4e"></stop>
                                                            <stop offset="0.7058" style="stop-color: #464752"></stop>
                                                            <stop offset="0.9509" style="stop-color: #555557"></stop>
                                                            <stop offset="1" style="stop-color: #595959"></stop>
														</linearGradient>
...
C1682.1,698.8,1682.1,698.8,1682.1,698.9z M1680.4,699.9l0.3,0.6l0.6-0.4l-0.3-0.6L1680.4,699.9z"></path>
													</g>
                                                    <g>
														<g opacity="0.25">
...
C1525.1,794.8,1525.1,794.8,1525.1,794.9z M1523.4,795.9l0.3,0.6l0.6-0.4l-0.3-0.6L1523.4,795.9z"></path>
                                                        ...
                                                        <linearGradient id="SVGID_134_" gradientUnits="userSpaceOnUse" x1="1553.097" y1="420.8045" x2="1662.411" y2="420.8045" gradientTransform="matrix(1 0 0 -1 0 1200)">
															<stop offset="0" style="stop-color: #bfbfbf"></stop>
                                                            <stop offset="0.1122" style="stop-color: #aaaaae"></stop>
                                                            <stop offset="0.4064" style="stop-color: #767884"></stop>
                                                            <stop offset="0.6631" style="stop-color: #515366"></stop>
                                                            <stop offset="0.8695" style="stop-color: #3a3d54"></stop>
                                                            <stop offset="1" style="stop-color: #32354d"></stop>
														</linearGradient>
...
l-2.8,1.8l0.8,1.2L1561.2,809.8z M1556.7,812.5l-0.8-1.2l-2.8,1.8l0.8,1.2L1556.7,812.5z"></path>
													</g>
                                                    <g>
														<g opacity="0.15">
...
C1366.1,891.8,1366.1,891.8,1366.1,891.9z M1364.4,892.9l0.3,0.6l0.6-0.4l-0.3-0.6L1364.4,892.9z"></path>
...
l-2.8,1.8l0.8,1.2L1402.2,906.8z M1397.7,909.5l-0.8-1.2l-2.8,1.8l0.8,1.2L1397.7,909.5z"></path>
													</g>
                                                    <g>
														<g opacity="0.25">
                                                        ...
                                                        <linearGradient id="SVGID_143_" gradientUnits="userSpaceOnUse" x1="1234.4193" y1="157.2996" x2="1178.0508" y2="192.9343" gradientTransform="matrix(1 0 0 -1 0 1200)">
                                                            ...
                                                            <stop offset="4.910000e-02" style="stop-color: #555557"></stop>
                                                            <stop offset="0.2942" style="stop-color: #464752"></stop>
                                                            <stop offset="0.58" style="stop-color: #3d3f4e"></stop>
                                                            <stop offset="1" style="stop-color: #3a3c4d"></stop>
														</linearGradient>
...
L1207,989.6C1207,989.6,1207,989.6,1207,989.6z M1205.3,990.6l0.3,0.6l0.6-0.4l-0.3-0.6L1205.3,990.6z"></path>
...
L1238.6,1007.2z"></path>
                                                    ...
                                                    <linearGradient id="SVGID_145_" gradientUnits="userSpaceOnUse" x1="1179.2999" y1="193.9759" x2="969.9731" y2="325.7959" gradientTransform="matrix(1 0 0 -1 0 1200)">
														<stop offset="0" style="stop-color: #32354d"></stop>
                                                        <stop offset="0.1305" style="stop-color: #3a3d54"></stop>
                                                        <stop offset="0.3369" style="stop-color: #515366"></stop>
                                                        <stop offset="0.5936" style="stop-color: #767884"></stop>
                                                        <stop offset="0.8878" style="stop-color: #aaaaae"></stop>
                                                        <stop offset="1" style="stop-color: #bfbfbf"></stop>
													</linearGradient>
...
l-2.8-1.8l-0.8,1.2L972.2,875.7z"></path>
...
l0.8-1.2l-2.8-1.8l-0.8,1.2L1447.2,588.7z"></path>
...
955,672.8 		"></polygon>
                                                    ...
                                                    <linearGradient id="SVGID_148_" gradientUnits="userSpaceOnUse" x1="763.4714" y1="1027.7656" x2="725.6356" y2="878.7339" gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)">
														<stop offset="0" style="stop-color: #ff808b"></stop>
                                                        <stop offset="0.3874" style="stop-color: #ffb2b9; stop-opacity: 0.5873"></stop>
...
954.8,596.8 		"></polygon>
                                                    ...
                                                    <linearGradient id="SVGID_149_" gradientUnits="userSpaceOnUse" x1="608.2545" y1="1006.7597" x2="591.3518" y2="855.3317" gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)">
														<stop offset="0" style="stop-color: #ffffff"></stop>
                                                        <stop offset="0.1993" style="stop-color: #c5c6d1; stop-opacity: 0.8007"></stop>
                                                        <stop offset="0.3919" style="stop-color: #9497ab; stop-opacity: 0.6081"></stop>
                                                        <stop offset="0.5731" style="stop-color: #6e728d; stop-opacity: 0.4269"></stop>
                                                        <stop offset="0.7399" style="stop-color: #535878; stop-opacity: 0.2601"></stop>
                                                        <stop offset="0.8874" style="stop-color: #43486b; stop-opacity: 0.1126"></stop>
                                                        <stop offset="1" style="stop-color: #3d4266; stop-opacity: 0"></stop>
													</linearGradient>
...
1272.8,407.8 		"></polygon>
                                                    ...
                                                    <linearGradient id="SVGID_154_" gradientUnits="userSpaceOnUse" x1="1332.3284" y1="958.5676" x2="1315.4257" y2="807.1397" gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)">
														<stop offset="0" style="stop-color: #ffffff"></stop>
                                                        <stop offset="8.269999e-02" style="stop-color: #e2e2e5; stop-opacity: 0.9173"></stop>
                                                        <stop offset="0.2656" style="stop-color: #a8a9af; stop-opacity: 0.7344"></stop>
                                                        <stop offset="0.4423" style="stop-color: #777983; stop-opacity: 0.5577"></stop>
                                                        <stop offset="0.6084" style="stop-color: #515460; stop-opacity: 0.3916"></stop>
                                                        <stop offset="0.7614" style="stop-color: #363947; stop-opacity: 0.2386"></stop>
                                                        <stop offset="0.8967" style="stop-color: #262938; stop-opacity: 0.1033"></stop>
                                                        <stop offset="1" style="stop-color: #202333; stop-opacity: 0"></stop>
													</linearGradient>
...
1273,407.4 		"></polygon>
                                    ...
                                    <input type="text" placeholder="Nombre" name="firstName" class="name-valid" required="">
                                    <input type="text" placeholder="Apellido" name="lastName" class="lastname-valid" required="">
                                    <input type="email" placeholder="E-mail" name="email" class="email-valid" required="">

                                    <div class="iti iti--allow-dropdown iti--separate-dial-code"><div class="iti__flag-container"><div class="iti__selected-flag" role="combobox" aria-controls="iti-0__country-listbox" aria-owns="iti-0__country-listbox" aria-expanded="false" tabindex="0" title="Spain (España): +34" aria-activedescendant="iti-0__item-es"><div class="iti__flag iti__es"></div><div class="iti__selected-dial-code">+34</div><div class="iti__arrow"></div></div></div><input type="tel" name="inputPhone" class="phone-valid" required="" autocomplete="off" data-intl-tel-input-id="0" placeholder="612 34 56 78" style="padding-left: 75px;"></div>
                                    

                                    <button class="send-btn">Empezar a ganar</button>
                                </form>
                            ...
                            <div class="mainComments">
                                <div class="commentsHeader">
                                    <div class="commentsHeader__left">
                                        <a scroll="goToForm" href=""> <b>Todos</b> 385 </a>
                                        <a scroll="goToForm" href="">
                                            <b>El mío</b>
                                        </a>
                                    </div>
                                    <div class="commentsHeader__right">
                                        <span> De lo mejor </span>
                                        <img src="img/chevron.svg" alt="more">
                                    </div>
                                </div>

                                <div class="comment replied">
                                    <a scroll="goToForm" class="commentAvatar" href="">
                                        <img src="img/comm1.webp" alt="comment">
                                    </a>
                                    <div class="commentBody">
                                        <div class="commentHeader">
                                            <div class="commentHeader__left">
                                                <a class="commentAuthor" scroll="goToForm" href=""> Pablo Ruiz </a>
                                        ...
                                        <p>Funciona realmente? He oído hablar de algo parecido, pero nunca he leído
                                            ninguna reseña.</p>
                                        <div class="commentFooter">
                                            <a scroll="goToForm" href=""> </a><a scroll="goToForm" href="">
                                            Responder </a>
                                            <span class="commentFooter__divider"> </span>
                                            <a scroll="goToForm" class="like" href="">
                                                <img src="img/heart.svg" alt="like">
                                            </a>
                                            <a scroll="goToForm" class="comment__reactions" href="">
                                                <img src="img/heart.svg" alt="likes">
                                                <span> 98 </span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="comment reply">
                                    <a scroll="goToForm" class="commentAvatar" href="">
                                        <img src="img/comm2.webp" alt="comment">
                                    </a>
                                    <div class="commentBody">
                                        <div class="commentHeader">
                                            <div class="commentHeader__left">
                                                <a class="commentAuthor" scroll="goToForm" href=""> Antonio Moreno </a>
                                        ...
                                        <p>Acabo de retirar mis ganancias... Usa el cerebro y regístrate. Estás
                                            perdiendo una oportunidad de la que te arrepentirás el resto de tu vida.</p>
                                        <div class="commentFooter">
                                            <a scroll="goToForm" href="">
                                                <span> Responder </span>
                                            </a>
                                ...
                                <div class="comment">
                                    <a scroll="goToForm" class="commentAvatar" href="">
                                        <img src="img/comm3.webp" alt="comment">
                                    </a>
                                    <div class="commentBody">
                                        <div class="commentHeader">
                                            <div class="commentHeader__left">
                                                <a class="commentAuthor" scroll="goToForm" href=""> Carmen
                                                    Rodríguez </a>
                                        ...
                                        <p>Por fin he encontrado tiempo para comprarme un coche nuevo. Ha sido un sueño
                                            hecho realidad... ¡pero los sueños se hacen realidad!</p>
                                        <a scroll="goToForm" href="">
                                            <img src="img/comimg1.webp" alt="con" style="width: 100%;">
                                        </a>
                                        <div class="commentFooter">
                                            <a scroll="goToForm" href="">
                                                <span> Responder </span>
                                ...
                                <div class="comment">
                                    <a scroll="goToForm" class="commentAvatar" href="">
                                        <img src="img/comm4.webp" alt="comment">
                                    </a>
                                    <div class="commentBody">
                                        <div class="commentHeader">
                                            <div class="commentHeader__left">
                                                <a class="commentAuthor" scroll="goToForm" href=""> Sergio Jiménez </a>
                                        ...
                                        <p>Ahora tengo la oportunidad de irme de vacaciones este año! Y lo mejor es que
                                            estaré de vacaciones y el sistema seguirá ganando dinero día y noche. ¡Es
                                            simplemente mágico!</p>
                                        <div class="commentFooter">
                                            <a scroll="goToForm" href="">
                                                <span> Responder </span>
                                            </a>
                                ...
                                <div class="comment replied">
                                    <a scroll="goToForm" class="commentAvatar" href="">
                                        <img src="img/comm5.webp" alt="comment">
                                    </a>
                                    <div class="commentBody">
                                        <div class="commentHeader">
                                            <div class="commentHeader__left">
                                                <a class="commentAuthor" scroll="goToForm" href=""> Lucía Sánchez </a>
                                                <span> Hace 15 horas </span>
                                            </div>
                                            <a scroll="goToForm" href="">
                                                <img src="img/more.svg" alt="more">
                                        ...
                                        <p>Me registré la semana pasada y ya he ganado 7 400 €! Se lo recomiendo a todo
                                            el mundo.</p>
                                        <a scroll="goToForm" href="">
                                            <img src="img/comimg2.webp" alt="con">
                                        </a>
                                        <div class="commentFooter">
                                            <a scroll="goToForm" href="">
                                                <span> Responder </span>
                                ...
                                <div class="comment reply">
                                    <a scroll="goToForm" class="commentAvatar" href="">
                                        <img src="img/comm6.webp" alt="comment">
                                    </a>
                                    <div class="commentBody">
                                        <div class="commentHeader">
                                            <div class="commentHeader__left">
                                                <a class="commentAuthor" scroll="goToForm" href=""> Paula Fernández </a>
                                        ...
                                        <p>Me acabo de inscribir, chicos, ¡deseadme suerte!</p>
                                        <div class="commentFooter">
                                            <a scroll="goToForm" href="">
                                                <span> Responder </span>
                                            </a>
                                ...
                                <div class="comment reply">
                                    <a scroll="goToForm" class="commentAvatar" href="">
                                        <img src="img/comm7.webp" alt="comment">
                                    </a>
                                    <div class="commentBody">
                                        <div class="commentHeader">
                                            <div class="commentHeader__left">
                                                <a class="commentAuthor" scroll="goToForm" href=""> Luis Navarro </a>
                                        ...
                                        <style>.commentBody p::first-letter {
                                            all: unset !important;
                                        }</style>
                                        <p>Me registré hace dos días y mi saldo ya es de 2145 €. Estoy pensando en
                                            solicitar un retiro, ¿o es demasiado pronto? No he hecho nada y el dinero se
                                            ha acreditado automáticamente de alguna manera...</p>
                                        <div class="commentFooter">
                                            <a scroll="goToForm" href="">
                                                <span> Responder </span>
                                            </a>
                            ...
                            <a class="button-link" scroll="goToForm" href="">Únete a nosotros</a>
                            <p><a scroll="goToForm" style="color:red;" href="">Meridalis App</a> y empieza a ganar
                                dinero!</p>
                ...
                <aside class="totem">
                        ...
                        <ul>
                            <li class="cell first">
                                <article class="mod">
                                    <div class="mainBox">
                                        ...
                                        <div class="mediaBox noticBox " data-assetid="16918530_es_noticias" data-sust="false" data-autoplay="true" data-location="alacarta_videos" data-related="true" data-id="16918530">
                                       <span class="ima T H f16x9">
                                       <img src="img/16918530.jpg" itemprop="image" alt="España celebra la amnistía anunciada por la presidenta encargada de Venezuela y pide que se concrete con rapidez" title="España celebra la amnistía anunciada por la presidenta encargada de Venezuela y pide que se concrete con rapidez">
                                       </span>
                                            <a scroll="goToForm" title="Noticia: España celebra la amnistía anunciada por la presidenta encargada de Venezuela y pide que se concrete con rapidez" href="">
                                       ...
                                       <img src="img/blank.gif" alt="">
                                        ...
                                        <div class="txtBox">
                                          ...
                                          España celebra la amnistía anunciada por la presidenta encargada de Venezuela y pide que se concrete con rapidez
                                          </span>
                                            </h3>
                                            <span class="datpub">31.01.2026</span>
                                        </div>
                                    </div>
                                </article>
                            </li>
                            <li class="cell">
                                <article class="mod">
                                    <div class="mainBox">
                                        <div class="anteBox"></div>
                                        <div class="mediaBox noticBox " data-assetid="16918104_es_noticias" data-sust="false" data-autoplay="true" data-location="alacarta_videos" data-related="true" data-id="16918104">
                                       <span class="ima T H f16x9">
                                       <img src="img/16918104.jpg" itemprop="image" alt="Delcy Rodríguez propone una ley de amnistía general para " reparar="" las="" heridas"="" en="" venezuela"="" title="Delcy Rodríguez propone una ley de amnistía general para ">
                                       </span>
                                            <a scroll="goToForm" title="Noticia: Delcy Rodríguez propone una ley de amnistía general para " reparar="" las="" heridas"="" en="" venezuela"="" href="">
                                            <span class="ico notic">
                                       <img src="img/blank.gif" alt="">
                                       </span>
                                            </a>
                                        ...
                                        <div class="txtBox">
                                            <h3>
                                          <span class="maintitle">
                                          Delcy Rodríguez propone una ley de amnistía general para "reparar las heridas" en Venezuela
                                          </span>
                                            </h3>
                                            <span class="datpub">31.01.2026</span>
                                        </div>
                            ...
                            <li class="cell">
                                <article class="mod">
                                    <div class="mainBox">
                                        <div class="anteBox"></div>
                                        <div 16918194="" class="mediaBox videoBox " data-assetid="16918194_es_videos" data-sust="false" data-autoplay="true" data-location="alacarta_videos" data-related="true" data-id="16918194" data-config="{" id="" ":"16918194","location":"alacarta_videos","sust":false,"autoplay":true,"type":"video","csstype":"video","related":true,"capitalizedtype":"video","alt":"delcy="" rodríguez="" propone="" una="" ley="" de="" amnistía="" general="" para="" venezuela","title":"delcy="" venezuela","datatitle":"\"delcy="" venezuela\"","typeid":"39816","htmlurl":"https:="" www.rtve.es="" play="" videos="" fin-de-semana-24h="" delcy-rodriguez-propone-ley-amnistia-general-para-venezuela="" ","programinfotitle":"","shorttitle":"","episode":"","shortdescription":"","agerange":"","agerangeuidclass":"","hdcontentavailable":"","promotitle":"","subtype":"","imgsquare":false,"programinfoagerange":"","titleprograminfoagerange":"'delcy="" venezuela'","descriptionvideo":null,"img":{"large":{"url":"https:="" img.rtve.es="" v="" 16918194?w="1600" ,"width":1600,"media":"(min-width:"="" 1000px)"},"big":{"url":"https:="" 1200px)"},"normal":{"url":"https:="" 800px)"},"small":{"url":"https:="" 400px)"},"none":{"url":"","width":0,"media":""}},"url":"https:="" ","date":{"label":"31.01.2026","key":"2026-01-31"},"language":"es","pubdest":"noticias","pubstate":{"code":"enpub","description":"en="" publicación"},"disablestriplayer":"","mediainfo":null,"mediaconfig":{"configurl":"="" api="" config="" alacarta_videos.json","whitelisturl":"="" swf="" data="" whitelist.xml","propertiesplayerurl":"="" v2="" playerconfig="" propertiesplayer.xml","rtveplayerswfurl":"="" js="" rtveplayerjs.swf","ztnrflashurl":"="" z.swf","relacionadosrefurl":"="" relacionados.json","relatedbylangrefurl":"="" relacionados="" relacionados-por-idioma.json","adapter":false,"fullassetid":"16918194_es_videos","ztnrmvlthumburl":"="" ztnr="" movil="" thumbnail="" {idmanager}="" 16918194.png","lokiurl":"="" odin="" loki="" {chunk}="" ","thumbnailerurl":"="" resources="" thumbnailer="" {hash}="" {id}="" l{levelid}_m{matrixid}.jpg","errorlayerclass":"vjs-error-display","agerangeinfo":{"agerangeuid":null,"agerangedesc":"","agerangecssclass":""},"subtitlerefurl":"="" subtitulos.json","cuepointsurl":"="" cuepoints.json","transcripcionurl":"="" transcripcion.json","promosurl":"="" publicidad.json","mediainfoconfig":{"cssclass":"textrel","hasmediatextclass":"hasmediatext"}}}"="">
                                        <span class="ima T H f16x9">
                                    <img src="img/16918194.jpg" itemprop="image" alt="Delcy Rodríguez propone una ley de amnistía general para Venezuela" title="Delcy Rodríguez propone una ley de amnistía general para Venezuela">
                                    </span>
                                        <a scroll="goToForm" title="Video: Delcy Rodríguez propone una ley de amnistía general para Venezuela" href="">
                                    <span class="ico play video">
                                    <img src="img/blank.gif" alt="reproducir video">
                                    ...
                                    <div class="txtBox">
                                        <h3>
                                       <span class="maintitle">
                                       Delcy Rodríguez propone una ley de amnistía general para Venezuela
                                       </span>
                                        </h3>
                                        <span class="datpub">31.01.2026</span>
                                    </div>
                    ...
                    <li class="cell">
                        <article class="mod">
                            <div class="mainBox">
                                <div class="anteBox"></div>
                                <div class="mediaBox noticBox " data-assetid="16916241_es_noticias" data-sust="false" data-autoplay="true" data-location="alacarta_videos" data-related="true" data-id="16916241">
                     <span class="ima T H f16x9">
                     <img src="img/16916241.jpg" itemprop="image" alt="Delcy Rodríguez firma la ley que permite abrir la industria petrolera venezolana a la inversión privada e internacional" title="Delcy Rodríguez firma la ley que permite abrir la industria petrolera venezolana a la inversión privada e internacional">
                     </span>
                                    <a scroll="goToForm" title="Noticia: Delcy Rodríguez firma la ley que permite abrir la industria petrolera venezolana a la inversión privada e internacional" href="">
                     <span class="ico notic">
                     <img src="img/blank.gif" alt="">
                     </span>
                                    </a>
                                ...
                                <div class="txtBox">
                                    <h3>
                     <span class="maintitle">
                     Delcy Rodríguez firma la ley que permite abrir la industria petrolera venezolana a la inversión privada e internacional
                     </span>
                                    </h3>
                    ...
                    <li class="cell">
                        <article class="mod">
                            <div class="mainBox">
                                <div class="anteBox"></div>
                                <div 16918609="" class="mediaBox videoBox " data-assetid="16918609_es_videos" data-sust="false" data-autoplay="true" data-location="alacarta_videos" data-related="true" data-id="16918609" data-config="{" id="" ":"16918609","location":"alacarta_videos","sust":false,"autoplay":true,"type":"video","csstype":"video","related":true,"capitalizedtype":"video","alt":"amnistía="" general="" en="" venezuela,="" un="" paso="" hacia="" la="" transición="" del="" país="" |="" ver","title":"los="" familiares="" de="" presos="" celebran="" amnistía="" anunciada="" venezuela="" a="" espera="" que="" se="" concrete","datatitle":"\"los="" concrete\"","typeid":39978,"htmlurl":"https:="" www.rtve.es="" play="" videos="" telediario-fin-de-semana="" familiares-presos-celebran-amnistia-general-anunciada-venezuela-espera-se-concrete="" ","programinfotitle":"telediario="" fin="" semana","shorttitle":"","episode":"","shortdescription":"la="" ha="" anunciado="" este="" sábado="" presidenta="" interina="" venezolana,="" delcy="" rodríguez,="" sido="" recibida="" con="" júbilo="" por="" los="" políticos.="" líder="" opositora="" maría="" corina="" machado="" lo="" atribuye="" presión="" estados="" unidos="" tras="" captura="" nicolás="" maduro.="" todavía="" está="" concretarse="" cómo="" llevará="" cabo.","agerange":"recomendable="" para="" todos="" públicos","agerangeuidclass":"","hdcontentavailable":"","promotitle":"","subtype":"","duration":"01.22="" min","imgsquare":false,"programinfoagerange":"recomendable="" públicos","titleprograminfoagerange":"'los="" concrete'="" recomendable="" públicos","descriptionvideo":"la="" familiares...","programid":"135932","img":{"large":{"url":"https:="" img.rtve.es="" v="" 16918609?w="1600&amp;preview=01769864192732.jpg" ,"width":1600,"media":"(min-width:"="" 1000px)"},"big":{"url":"https:="" 1200px)"},"normal":{"url":"https:="" 800px)"},"small":{"url":"https:="" 400px)"},"none":{"url":"","width":0,"media":""}},"url":"https:="" ","date":{"label":"31.01.2026","key":"2026-01-31"},"language":"es","pubdest":"noticias","pubstate":{"code":"enpub","description":"en="" publicación"},"disablestriplayer":"","mediainfo":null,"mediaconfig":{"configurl":"="" api="" config="" alacarta_videos.json","whitelisturl":"="" swf="" data="" whitelist.xml","propertiesplayerurl":"="" v2="" playerconfig="" propertiesplayer.xml","rtveplayerswfurl":"="" js="" rtveplayerjs.swf","ztnrflashurl":"="" z.swf","relacionadosrefurl":"="" relacionados.json","relatedbylangrefurl":"="" relacionados="" relacionados-por-idioma.json","adapter":false,"fullassetid":"16918609_es_videos","ztnrmvlthumburl":"="" ztnr="" movil="" thumbnail="" {idmanager}="" 16918609.png","lokiurl":"="" odin="" loki="" {chunk}="" ","thumbnailerurl":"="" resources="" thumbnailer="" {hash}="" {id}="" l{levelid}_m{matrixid}.jpg","errorlayerclass":"vjs-error-display","agerangeinfo":{"agerangeuid":"if_redad0","agerangedesc":"para="" públicos","agerangecssclass":"mas00"},"subtitlerefurl":"="" subtitulos.json","cuepointsurl":"="" cuepoints.json","transcripcionurl":"="" transcripcion.json","promosurl":"="" publicidad.json","mediainfoconfig":{"cssclass":"textrel","hasmediatextclass":"hasmediatext"}}}"="" data-consumption="ondemand">

                                <span class="ico redad mas00">
                     <img src="img/a1fdee122b95748d81cee426d717c05b5174fe96.gif" alt="Para todos los públicos">
                     </span>
                                <span class="ima T H f16x9">
                     <img src="img/16918609.jpg" itemprop="image" alt="Amnistía general en Venezuela, un paso hacia la transición del país | Ver" title="Los familiares de presos celebran la amnistía general anunciada en Venezuela a la espera de que se concrete">
                     </span>
                                <a scroll="goToForm" title="Video: Los familiares de presos celebran la amnistía general anunciada en Venezuela a la espera de que se concrete" href="">
                     <span class="ico play video">
                     <img src="img/blank.gif" alt="reproducir video">
                     <span class="duration">01.22 min</span>
                            ...
                            <div class="txtBox">
                                <h3>
                     <span class="maintitle">
                     Los familiares de presos celebran la amnistía general anunciada en Venezuela a la espera de que se concrete
                     </span>
                                </h3>
                                <span class="datpub">31.01.2026</span>
                            </div>
            ...
            <ul class="listag">
                <li>
               <span class="boton">
               <a title="Venezuela" scroll="goToForm" href="">
               <strong>Venezuela</strong>
                ...
                <li>
               <span class="boton">
               <a title="Estados Unidos ataca Venezuela" scroll="goToForm" href="">
               <strong>Estados Unidos ataca Venezuela</strong>
               </a>
               </span>
                </li>
                <li>
               <span class="boton">
               <a title="Amnistía" scroll="goToForm" href="">
               <strong>Amnistía</strong>
               </a>
               </span>
                </li>
                <li>
               <span class="boton">
               <a title="Derechos Humanos" scroll="goToForm" href="">
               <strong>Derechos Humanos</strong>
                ...
                <li>
               <span class="boton">
               <a title="Justicia" scroll="goToForm" href="">
    ...
    <div class="DatosContainer" data-id="16918258" data-tipo="noticias_RTV_NOTICIA"></div>
</div>
</div>
</main></div>
<div class="container">
...
<div class="wrapper footer" id="footer" data-locale="ES">
    <div class="container">
        <ul>
            <li>
                <a scroll="goToForm" title="Ir a portada principal de la Web de RTVE" href="">
                    <img alt="RTVE.es" src="img/PG_logo_RTVEes.png">
                </a>
                <span class="blind material-icon menu" aria-hidden="true" tabindex="0">
                  <span class="ghost">Men de navegacin principal</span>
                  </span>
                <div class="blindBox">
                    <ul>
                        <li><a scroll="goToForm" href=""><span>Noticias</span></a></li>
                        <li><a scroll="goToForm" href=""><span>RTVE Play</span></a></li>
                        <li><a scroll="goToForm" href=""><span>RNE Audio</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Filmoteca</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Televisin</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Radio</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Deportes</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Tiempo</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Clan</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Laboratorio</span></a></li>
                    </ul>
                </div>
            </li>
            <li>
                <a scroll="goToForm" title="Ir a portada de Televisin Espaola" class="tve" href="">
                    <img alt="TVE" src="img/PG_logo_TVE.png">
                </a>
                <span class="blind material-icon menu" aria-hidden="true" tabindex="0">
                  <span class="ghost">Men de Televisin Espaola</span>
                  </span>
                <div class="blindBox">
                    <ul>
                        <li><a scroll="goToForm" href=""><span>2 Dividendo Digital</span></a></li>
                        <li><a scroll="goToForm" href=""><span>RTVE Botn Rojo</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Corresponsalas</span></a></li>
                        <li><a scroll="goToForm" href=""><span>TVE Internacional</span></a></li>
                        <li><a scroll="goToForm" href=""><span>TVE Catalunya</span></a></li>
                        <li><a scroll="goToForm" href=""><span>TVE Canarias</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Teletexto</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Centros Territoriales</span></a></li>
                        <li><a scroll="goToForm" href=""><span>TVE en directo</span></a></li>
                    </ul>
                </div>
            </li>
            <li>
                <a scroll="goToForm" title="Ir a portada de Radio Nacional de Espaa" class="rne" href="">
                    <img alt="RNE" src="img/PG_logo_RNE.png">
                </a>
                <span class="blind material-icon menu" aria-hidden="true" tabindex="0">
                  <span class="ghost">Men de Radio Nacional de  Espaa</span>
                  </span>
                <div class="blindBox">
                    <ul>
                        <li><a scroll="goToForm" href=""><span>Radio Nacional</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Radio Clsica</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Radio 3</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Rdio 4</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Radio 5</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Radio Exterior</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Podcast</span></a></li>
                    </ul>
                </div>
            </li>
            <li>
                <a scroll="goToForm" title="Ir a portada de Transparencia" class="cor" href="">
                    <img alt="RTVE" src="img/PG_logo_RTVE.png">
                </a>
                <span class="blind material-icon menu" aria-hidden="true" tabindex="0">
                  <span class="ghost">Men de la Corporacin RTVE</span>
                  </span>
                <div class="blindBox">
                    <ul>
                        <li><a scroll="goToForm" href=""><span>Transparencia</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Sostenibilidad</span></a></li>
                        <li><a scroll="goToForm" href=""><span>RTVE Comunicacin</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Manual de estilo</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Cdigo de autorregulacin</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Derecho de acceso</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Ofertas de empleo</span></a></li>
                        <li><a scroll="goToForm" href=""><span>RTVE 2030</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Defensora de la Audiencia</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Observatorio de Igualdad</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Canal tico</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Instituto RTVE</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Orquesta Sinfnica y Coro RTVE</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Direccin Comercial</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Impulsa Visin</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Perfil del Contratante</span></a></li>
                        <li><a scroll="goToForm" href=""><span>Contratacin audiovisuales</span>
                        </a>
                        </li>
                    </ul>
                    <a scroll="goToForm" href="">
            ...
            <li class="endBox">
                ...
                <ul>
                    ...
                    <li><a scroll="goToForm" href="">
                    </a><a title="Se abre pgina nueva" aria-label="Condiciones de utilizacin del sitio RTVE.es" scroll="goToForm" href="">
                        <span>Aviso legal</span>
                    </a>
                    </li>
                    <li>
                        <a title="Se abre pgina nueva" aria-label="Poltica de RTVE sobre el tratamiento de datos personales" scroll="goToForm" href="">
                            <span>Poltica de privacidad</span>
                        </a>
                    </li>
                    <li>
                        <a title="Se abre pgina nueva" aria-label="Poltica de RTVE sobre el tratamiento de datos cookies" scroll="goToForm" href="">
                            <span>Poltica de cookies</span>
                        </a>
                    </li>
                    <li>
                        <a aria-label="Pgina sobre la accesibilidad del Portal de RTVE.es" scroll="goToForm" href="">
                            <span>Accesibilidad</span>
                        </a>
                    </li>
                    <li>
                        <a aria-label="Mapa del sitio RTVE.es" scroll="goToForm" href="">
                            <span>Mapa web</span>
                        </a>
                    </li>
                    <li>
                        <a aria-label="Preguntas frecuentes, direcciones de contacto de la Corporacin RTVE.es, Oficina del Defensor" scroll="goToForm" href="">
                            <span>Contacto</span>
                        </a>
                    </li>
                    <li>
                        <a title="Se abre pgina nueva" aria-label="Poltica de RTVE.es sobre comentarios y participacin social de usuarios" scroll="goToForm" href="">
                            <span>Normas de Participacin</span>
                        </a>
                    </li>
                </ul>
                <span itemscope="" itemtype="https://schema.org/CreativeWork">
                  <a itemprop="url" scroll="goToForm" href="">
                  <span itemprop="copyrightHolder"></span><strong>Corporacin de Radio y Televisin Espaola 2026</strong>
                  </a>
                  </span>
            </li>
        </ul>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const profit30 = document.getElementById("profit14");
        const profit180 = document.getElementById("profit30");
        ...
        function updateCalculator(value) {
            const day1 = value * dailyCoef;
            const day30 = value * dailyCoef * 30;
            const day180 = value * dailyCoef * 180;

            currentValue.innerHTML = `${formatNumber(value)}&nbsp;${currencySymbol}`;
            profit1.innerHTML = `${formatNumber(day1)}&nbsp;${currencySymbol}`;
            profit30.innerHTML = `${formatNumber(day30)}&nbsp;${currencySymbol}`;
            profit180.innerHTML = `${formatNumber(day180)}&nbsp;${currencySymbol}`;
        }

        slider.value = slider.min;
        updateCalculator(Number(slider.value));

        slider.addEventListener("input", (e) => {
            updateCalculator(Number(e.target.value));
        });
    });
</script>
...
<div class="countdown-widget" id="countdown-widget">
  <p class="countdown-widget__label">⏰ Offer expires in:</p>
  <div class="countdown-widget__timer">
    <div class="countdown-unit">
      <span class="countdown-unit__value" id="cdw-hours">00</span>
      <span class="countdown-unit__label">Hours</span>
    </div>
    <span class="countdown-widget__sep">:</span>
    <div class="countdown-unit">
      <span class="countdown-unit__value" id="cdw-minutes">00</span>
      <span class="countdown-unit__label">Minutes</span>
    </div>
    <span class="countdown-widget__sep">:</span>
    <div class="countdown-unit">
      <span class="countdown-unit__value" id="cdw-seconds">00</span>
      <span class="countdown-unit__label">Seconds</span>
    </div>
  </div>
</div>
<script src="widgets/countdown-timer/widget.js"></script><?php require_once '/var/www/keitaro/lander/include-thanks-page/offer_footer_script.php'; ?>
</body></html>